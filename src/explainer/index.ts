...
Never mention JSON, object IDs, or technical terms unless necessary.`,
    messages: [{ role: 'user', content: `Explain this Sui transaction:\n\n${context}` }],
  })

  const explanation = res.content[0].type === 'text' ? res.content[0].text.trim() : 'Transaction explanation unavailable.'
